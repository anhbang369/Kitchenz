...
class CategoryViewItem1 extends StatefulWidget {
  const CategoryViewItem1({Key? key}) : super(key: key);

  @override
  State<CategoryViewItem1> createState() => _CategoryViewItem1State();
}

class _CategoryViewItem1State extends State<CategoryViewItem1> {
